...
namespace Duckroll
{
	...
	public static class ModLog
	{
		...
		public const string ModName = "WicoResearch";
		public const int WorkshopId = 1301917772; //https://steamcommunity.com/sharedfiles/filedetails/?id=xxx
		public const string LogFile = "WR.log";
		...
		public static void Error(string msg)
		{
			...
			else
			{
				MyAPIGateway.Utilities.ShowNotification(
					@"Wico Research Mod has encountered an error. Please post your log on steam workshop.
